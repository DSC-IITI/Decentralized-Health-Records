    ...
    return <section className="px-5 lg:px-0">
        ...
        <form className="py-4 md:py-0">
            ...
            <div className="mt-7">
                ...
                text-[18px] leading-[30px] rounded-lg px-4 py-3">Login</button>
            </div>
            <p className="mt-5 text-textColor text-center">Don't have an account?<a href="/" className="text-primaryColor 
            font-medium ml-1">Register</a></p>
        </form>
        </div>
    </section>
}
